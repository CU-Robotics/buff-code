...
class Tracker:
    ...
    def callback(self, msg):
        ...
        predictions = [self.pred_1, self.pred_2, self.pred_3]
    ...
    def update_deltas(self):
        ...
        if self.prev_2 is not None:
            ...
            if self.prev_3 is not None:
                vel_1 = self.d_1
                vel_2 = (self.prev_2 - self.prev_3) / self.dt

                self.d_2 = (vel_1 - vel_2) / self.dt

                if self.prev_4 is not None:
                    acc_1 = self.d_2
                    vel_3 = (self.prev_3 - self.prev_4) / self.dt
                    acc_2 = (vel_2 - vel_3) / self.dt
                    acc_2 = (acc_1 - acc_2) / self.dt

                    self.d_3 = (acc_1 - acc_2) / self.dt
