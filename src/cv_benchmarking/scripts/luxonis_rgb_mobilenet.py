...
nnPathDefault = os.path.join(os.getenv('PROJECT_ROOT'), 'buffpy', 'data', 'models', 'mobilenet-ssd_openvino_2021.4_6shave.blob')
...
if not os.path.exists(nnPathDefault):
    import sys
    raise FileNotFoundError(f'cant find {nnPathDefault}')
