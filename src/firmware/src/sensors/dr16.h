...
#define JOYSTICK_X_SENSITIVITY 			300
#define JOYSTICK_Y_SENSITIVITY 			300
#define JOYSTICK_PAN_SENSITIVITY 		120
#define JOYSTICK_PITCH_SENSITIVITY 		30
