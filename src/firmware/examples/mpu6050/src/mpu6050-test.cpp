...
void setup() {
  ...
  Wire.beginTransmission(MPU);       // Start communication with MPU6050 // MPU=0x68
  Wire.write(0x38);                  // Talk to the register 6B
...
void loop() {
 ...
 Serial.print("Accel read time ");
  ...
  // Correct the outputs with the calculated error value

  Wire.beginTransmission(MPU);
  Wire.write(0x3A); // Start with register 0x3B (ACCEL_XOUT_H)
  Wire.endTransmission(false);
