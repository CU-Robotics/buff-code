...
curl -fsSL https://raw.githubusercontent.com/arduino/arduino-cli/master/install.sh | BINDIR=${DIR}/buffpy sh

export PATH="${PROJECT_ROOT}/buffpy:${PROJECT_ROOT}/buffpy/:${PATH}"
